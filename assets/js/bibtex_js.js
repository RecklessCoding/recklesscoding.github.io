/* 
 * Author = Patric Cooksey is the original autho of bibtex-js (https://github.com/pcooksey/bibtex-js). 
 * Andreas Theodorou edited, or rather butchered, together this version to add:
    -Support for additional types of select generated content
    -Talks.
    -A workaround on not having the same on all items. This makes it possible to create a Select system with options such as "show all", "show X without Y", and "Show only Y".
    -Coloured options in lists.
